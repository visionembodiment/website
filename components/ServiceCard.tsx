  ...
  return (
    <div className={cn(designSystem.cards.base, designSystem.cards.hover)}>
      ...
      <div className={designSystem.cards.padding}>
        <h3 className={cn(designSystem.text.h4, designSystem.colors.text.inverse, designSystem.spacing.margin.bottom.xs)}>{title}</h3>
        ...
        <div className={cn(designSystem.colors.border.divider, designSystem.spacing.margin.top.sm, designSystem.spacing.margin.bottom.sm, "pt-4")}>
          <div className={cn("flex justify-between items-center", designSystem.spacing.margin.bottom.xs)}>
            <span className={cn(designSystem.text.body.sm, designSystem.colors.text.muted)}>Price:</span>
            <span className={cn(designSystem.text.h3, designSystem.colors.text.inverse)}>{price}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className={cn(designSystem.text.body.sm, designSystem.colors.text.muted)}>Duration:</span>
            <span className={cn(designSystem.text.body.md, designSystem.colors.text.muted)}>{duration}</span>
          </div>
        </div>

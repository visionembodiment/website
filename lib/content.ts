...
export const aboutPageContent = {
  ...
  mission: {
    ...
    footnote: "This is real transformation. Not quick fixes. Not spiritual bypassing. This is the work.",
  },
...
export const contactPageContent = {
  ...
  form: {
    ...
    errorMessage: 'Something went wrong. Please try again or email directly at contact@visionembodiment.com',
  },
    ...
    items: [
      {
        icon: 'email',
        title: 'Email',
        value: 'contact@visionembodiment.com',
      },
      {
        icon: 'clock',
        title: 'Response Time',
